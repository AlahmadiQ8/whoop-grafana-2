...
namespace Whoop.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PaginatedRecoveryResponse")]
    public partial class PaginatedRecoveryResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaginatedRecoveryResponse" /> class.
        /// </summary>
        ...
        public PaginatedRecoveryResponse(List<Recovery> records = default(List<Recovery>), string nextToken = default(string))
        {
        ...
        public List<Recovery> Records { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaginatedRecoveryResponse {\n");
