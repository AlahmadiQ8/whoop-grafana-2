...
namespace Whoop.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PaginatedSleepResponse")]
    public partial class PaginatedSleepResponse : IValidatableObject
    {
        /// <summary>
        ...
        public PaginatedSleepResponse(List<Sleep> records = default(List<Sleep>), string nextToken = default(string))
        {
        ...
        public List<Sleep> Records { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaginatedSleepResponse {\n");
